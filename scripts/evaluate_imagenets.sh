...
#python -u /misc/vlgscratch4/LakeGroup/emin/oos_benchmarks/evaluate_imagenets.py '/misc/vlgscratch4/LakeGroup/emin/robust_vision/imagenet-sketch/' --model-name 'tf_efficientnet_b6_ns' --im-size 528
#python -u /misc/vlgscratch4/LakeGroup/emin/oos_benchmarks/evaluate_imagenets.py '/misc/vlgscratch4/LakeGroup/emin/robust_vision/imagenet-sketch/' --model-name 'tf_efficientnet_b5_ns' --im-size 456
#python -u /misc/vlgscratch4/LakeGroup/emin/oos_benchmarks/evaluate_imagenets.py '/misc/vlgscratch4/LakeGroup/emin/robust_vision/imagenet-sketch/' --model-name 'tf_efficientnet_b4_ns' --im-size 380
#python -u /misc/vlgscratch4/LakeGroup/emin/oos_benchmarks/evaluate_imagenets.py '/misc/vlgscratch4/LakeGroup/emin/robust_vision/imagenet-sketch/' --model-name 'tf_efficientnet_b3_ns' --im-size 300
